...
repository="https://githubfast.com/HLLF-FAN/readsb.git"
...
if grep -E 'wheezy|jessie' /etc/os-release -qs; then
    ...
    wget -O /tmp/rtl-sdr.rules https://githubfast.com/HLLF-FAN/ADSB-scripts/blob/main/osmocom-rtl-sdr.rules
...
rm -rf /etc/motd
wget -P /etc https://githubfast.com/HLLF-FAN/ADSB-scripts/blob/main/motd
